...
> ![http://xyq.163.com/images/emote/105.gif]({{ "/assets/img/105.gif" | relative_url}}) OAuth client support in Jersey is almost identical for OAuth 1 and OAuth 2. As such, this section provides useful
...
> ![http://xyq.163.com/images/emote/105.gif]({{ "/assets/img/105.gif" | relative_url}}) Note: It is suggested to read the section [Client](#client) before this section. Support for OAuth on the client is
