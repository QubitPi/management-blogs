...
> ![](http://xyq.163.com/images/emote/105.gif) Different systems may do different things to implement transactions. It is possible that as a transaction executes, it
