...
chart's `charts/` directory. Or, to puta it differently, a values file can supply values to the chart as well as to any
...
![configmag-test-1.png not loaded property]({{ "/assets/img/configmag-test-1.png" | relative_url}})
![configmag-test-2.png not loaded property]({{ "/assets/img/configmag-test-2.png" | relative_url}})
