...
The node2vec extends the probabilistic model of Skip-gram architecture in text analysis to graph analysis. It is,
therefore, important to learn the Skip-Gram Model first.
